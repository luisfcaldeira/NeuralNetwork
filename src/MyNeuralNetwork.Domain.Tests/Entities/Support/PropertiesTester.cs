...
namespace MyNeuralNetwork.Domain.Tests.Entities.Support
{
    internal class PropertiesTester
    {
        ...
        public static void TestBias(Neuron neuron, float expectBias)
        {
        ...
        public static void TestGamma(Neuron neuron, float expectedGamma)
        {
        ...
        public static void TestWeight(Neuron neuron, Neuron nextNeuron, float expectValue)
        {
